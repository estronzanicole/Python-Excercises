...
receipt = "Your total is " + str(total) # <--want the receipt with a string plus the str(string) and pass in the total in parens
print(receipt) 
...
# Numbers
"""[summary]
"""# Strings wrapper with single or double quotation marks
