...
cubed_nums = []          # get the cubed numbers(take all numbers and cube them)
...
#--------------------------------------------------------------------
#--------------------------------------------------------------------
cubed_nums = [num ** 3 for num in num_list]  # 3 separate components here  (num can be x or b or anything it's your iterator variable)
print(cubed_nums)
...
even_numbers = []                     # say even numbers ais equal to empty list
...
"""
start with square brackets to generate the list
